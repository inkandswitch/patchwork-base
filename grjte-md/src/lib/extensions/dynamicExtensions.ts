 ...
 */
export function createDynamicExtensionsCompartment(extensions: Accessor<Extension[]>) {
  ...
  return [dynamicCompartment.of(extensions()), createReconfigureEffect] as const;
}
